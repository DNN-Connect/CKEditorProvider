...
namespace ElFinder
{
    internal static class Helper
    {
        ...
        {
            return HttpServerUtility.UrlTokenEncode(System.Text.UTF8Encoding.UTF8.GetBytes(id.ToString()));
        }
        public static int DecodeId(string encId)
        {
            int id;
            if (!int.TryParse(System.Text.UTF8Encoding.UTF8.GetString(HttpServerUtility.UrlTokenDecode(encId)), out id))
                return -1;
