...
namespace ElFinder
{
    ...
    {
        public static bool IsFileFromCache(IFileInfo info, HttpRequestBase request, HttpResponseBase response)
        {
            DateTime updated = info.LastModificationTime.ToUniversalTime();
        ...
        private static string GetFileETag(IFileInfo info)
        {
            return "\"" + Helper.GetFileMd5(info) + "\"";
        }
