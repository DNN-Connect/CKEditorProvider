...
<div id="SettingsBox">
  <h2>CKEditor Provider <asp:Label id="lblSettings" runat="server">Settings</asp:Label></h2>    
    ...
    <ul class="dnnActions dnnClear">
        ...
        <li><a onclick="return showDialog('ImportDialog');" id="ckeditoroptions_lnkImport" class="dnnSecondaryAction importButton" href="#"><asp:Label id="lblImport" runat="server" Text="Import"></asp:Label></a></li>
        <li><a onclick="return showDialog('ExportDialog');" id="ckeditoroptions_Export" href="#" class="dnnSecondaryAction exportButton"><asp:Label id="lblExport" runat="server" Text="Export"></asp:Label></a></li>
    </ul>
